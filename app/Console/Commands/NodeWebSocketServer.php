...
class NodeWebSocketServer extends Command
{
    ...
    public function handle(): void
    {
        ...
        Worker::$logFile = $logPath . '/nxpanel-ws-server.log'; // 指向具体文件，避免某些环境 php://stdout 的 stat 失败
        Worker::$pidFile = $logPath . '/nxpanel-ws-server.pid';
