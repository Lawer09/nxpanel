...
use App\Console\Commands\NxpanelInstall;

class NxpanelUpdate extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'nxpanel:update';
     ...
     * @var string
     */
    protected $description = 'nxpanel 更新';
    ...
    public function handle()
    {
        ...
        NxpanelInstall::restoreProtectedPlugins($this);
