...
class ConfigController extends Controller
{
    ...
    public function testSendMail(Request $request)
    {
        $mailLog = MailService::sendEmail([
            ...
            'subject' => 'This is nxpanel test email',
            'template_name' => 'notify',
            'template_value' => [
                'name' => admin_setting('app_name', 'NxPanel'),
                'content' => 'This is nxpanel test email',
    ...
    private function getConfigMappings(): array
    {
        return [
            ...
            'site' => [
                ...
                'app_name' => admin_setting('app_name', 'NxPanel'),
                'app_description' => admin_setting('app_description', 'NxPanel is best!'),
            ...
            'frontend' => [
                'frontend_theme' => admin_setting('frontend_theme', 'NxPanel'),
