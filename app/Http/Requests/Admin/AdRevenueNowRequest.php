...
class AdRevenueNowRequest extends FormRequest
{
    /**
    ...
    /**
     * Validate filters, pagination, and sortable fields for current revenue data.
     */
    public function rules(): array
    {
        return [
            ...
            'orderBy'        => 'nullable|string|in:reportDate,accountId,providerAppId,devicePlatform,projectCode,nowEstimatedEarnings,nowUpdatedAt',
