...
class NodeServerReportNodeQueryRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'groupBy.*' => 'required|string|in:date,hour,node_id,node_type,node_host,node_public_ip,app_id,app_version',
            ...
            'orderBy' => 'nullable|string|in:date,hour,node_id,node_type,node_host,node_public_ip,app_id,app_version,traffic_upload,traffic_download,avg_cpu_usage,avg_mem_usage,max_cpu_usage,max_mem_usage,avg_disk_usage,avg_inbound_speed,avg_outbound_speed,max_inbound_speed,max_outbound_speed,avg_tcp_connections,max_tcp_connections,avg_alive_users,max_alive_users,compute_count,id,created_at,updated_at',
