...
class NodeServerReportUserQueryRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'groupBy.*' => 'required|string|in:date,hour,node_id,user_id,app_id,app_version,country',
            ...
            'orderBy' => 'nullable|string|in:date,hour,node_id,user_id,app_id,app_version,country,traffic_upload,traffic_download,compute_count,id,created_at,updated_at',
