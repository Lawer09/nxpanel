...
class PerformanceBatchReport extends FormRequest
{
    public function rules(): array
    {
        return [
            ...
            'ads_value_reports'           => 'nullable|array|min:0|max:100',
            'ads_value_reports.*.value_micros' => 'required|integer|min:0',
            'ads_value_reports.*.currency' => 'required|string|max:8',
    ...
    public function messages(): array
    {
        return [
            ...
            'ads_value_reports.max'               => 'ads_value_reports最多100条',
            'ads_value_reports.*.value_micros.required' => 'value_micros不能为空',
            'ads_value_reports.*.value_micros.integer' => 'value_micros必须为数字',
            'ads_value_reports.*.value_micros.min' => 'value_micros最小为0',
            'ads_value_reports.*.currency.required' => 'currency不能为空',
            'ads_value_reports.*.currency.max'    => 'currency长度不能超过8',
